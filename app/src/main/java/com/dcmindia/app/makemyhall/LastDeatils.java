...
/**
 * Created by Abu Osama on 31-07-2017.
 */

public class LastDeatils extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button= (Button) findViewById(R.id.booknonow1);
        Intent intent=getIntent();
        Bundle bundle=intent.getExtras();
        mobnumnerhall=bundle.getString("num");
